...
func addNewWavePacketsBasedOnSymmetry2(term *formula.EisensteinFormulaTerm, desiredSymmetry SymmetryType, newWavePackets []*WavePacket) []*WavePacket {
	powerN := term.PowerN
	powerM := term.PowerM
