...
Rectangular lattice with pmg symmetry [(Link to source file)](example/lattices/rainbow_stripe_lattice_rectangular_pmg.yml).
...
Hexagonal lattice with p31m symmetry [(Link to source file)](example/lattices/rainbow_stripe_lattice_hexagonal_p31m.yml)
...
Rhombic lattice with cmm symmetry [(Link to source file)](example/lattices/rainbow_stripe_lattice_rhombic_cmm.yml)
